...
using BookingEksamenDataManager.Repository;
...
builder.Services.AddTransient<IArtists, ArtistRepository>();
builder.Services.AddTransient<IBookers, BookerRepository>();
